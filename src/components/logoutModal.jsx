  ...
  return (
    <div className="__logout_modal__ fixed z-50 w-full bg-black/40  backdrop-blur-[1px] h-screen flex items-center justify-center">
      <div className="w-fit  px-6 py-8 mx-4 bg-white rounded-3xl">
        <h1 className="text-center text-red-600 font-bold pb-3 text-xl">
          Sign out?
        </h1>
        ...
        <section className="sm:flex flex-col sm:flex-row items-center flex justify-between w-full gap-2">
          <button
            ...
            className="px-6 text-slate-600  py-2 w-full rounded-xl border-2 border-slate-600 hover:border-red-500 hover:text-red-500 transition-colors duration-100 cursor-pointer "
          >
            cancel
          </button>
          <button
            onClick={() => handleLogout()}
            className="px-8 py-3 flex items-center justify-center w-full rounded-xl bg-red-600 hover:bg-red-700 transition-colors duration-100 text-white cursor-pointer "
          >
            {loggingOut ? (
